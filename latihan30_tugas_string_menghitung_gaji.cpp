...
int main(){
	...
	float gaji,tunjangan,pinjaman,pajak,gjktr,gjbrh=0;
    char lagi;
    int pgwke = 0;
    int hasil = 0;
    ...
    gjktr = gaji - tunjangan;
    cout << "Total Gaji Kotor   : " <<gjktr <<endl;
    
    gjbrh = gjktr - pinjaman - pajak;
    cout << "Total Gaji Bersih  : " <<gjbrh <<endl;
